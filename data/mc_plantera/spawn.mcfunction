...
execute as @a[scores:{bulbspawn=1..}] at @s run summon minecraft:vex ~ ~ ~ {Invisible:1,CustomName:'[{"text":"paa1"}]'}
execute as @a[scores:{bulbspawn=1..}] at @s run summon minecraft:vex ~ ~ ~ {Invisible:1,CustomName:'[{"text":"paa2"}]'}
execute as @a[scores:{bulbspawn=1..}] at @s run summon minecraft:vex ~ ~ ~ {Invisible:1,CustomName:'[{"text":"paa3"}]'}
execute as @a[scores:{bulbspawn=1..}] at @s run summon minecraft:vex ~ ~ ~ {Invisible:1,CustomName:'[{"text":"paa4"}]'}
